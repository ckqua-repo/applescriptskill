-- Search inbox for emails matching a subject keyword.
-- Usage: osascript search-by-subject.applescript "keyword" [limit]
...
on run argv
    ...
    tell application "Mail"
        set matchingMsgs to (messages of inbox whose subject contains keyword)
        set msgCount to count of matchingMsgs
        if msgCount is 0 then return "No messages found matching '" & keyword & "'"
